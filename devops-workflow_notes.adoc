...
* *Git branching strategy* : 
    ** feature branching (Gitflow, GitHub flow ou GitLab flow) vs trunk-based development : 
        ...
        *** https://hitesh-pattanayak.medium.com/git-flow-development-vs-trunk-based-debelopment-923ce4553043
            **** je ne cite cet article avant tout pour son bon schéma de comparaison des 2 stratégies (simple et efficace)
...
* Pour les ITS et outils de ticketing (bug reporting) : https://teambrain.fr/optimisez-votre-ticketing/
    ...
    ** Plume pour La Poste (surtout bureautique) : +
    "PLUME, c'est la Plateforme Unifiée pour le Management des services d'Entreprise du Groupe destinée à fédérer les actions des différents supports au service des postiers."
